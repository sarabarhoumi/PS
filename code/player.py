...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self,x,y,filename):
        ...
        self.image = pygame.image.load(f'C:\\Users\\White Devil\\Desktop\\PacMan\\code\\player.png').convert()
        self.image.set_colorkey(BLACK)
        self.rect = self.image.get_rect()
        self.rect.topleft = (x,y)
        # Load image which will be for the animation
        img = pygame.image.load(f'C:\\Users\\White Devil\\Desktop\\PacMan\\code\\walk.png').convert()
        ...
        img = pygame.image.load(f'C:\\Users\\White Devil\\Desktop\\PacMan\\code\\explosion.png').convert()
        self.explosion_animation = Animation(img, 30, 30)
        # Save the player image
        self.player_image = pygame.image.load(f'C:\\Users\\White Devil\\Desktop\\PacMan\\code\\player.png').convert()
